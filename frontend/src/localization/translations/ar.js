...
export default {
  ...
  onboarding: {
    ...
    phases: {
      single: {
        title: 'رحلة العزّاب',
        subtitle: 'اكتشاف الذات والوضوح',
        description: 'حدّد قيمك وتفضيلاتك بينما نُعدّ لك تعارفات وتجارب مثالية',
        icon: '🌸',
      },
      preparing: {
        title: 'الاستعداد للخطوبة',
        subtitle: 'تخطيط ومواءمة',
        description: 'ابنوا رؤية مشتركة، واؤمنوا القيم، وخطّطوا خطواتٍ هادفة معاً',
        icon: '💕',
      },
      engaged: {
        title: 'قبل الخطوبة',
        subtitle: 'تركيز وأناقة',
        description: 'تجارب مُنتقاة وقرارات ذكيّة أثناء التقدّم نحو مستقبلٍ ملتزم',
        icon: '💍',
      },
    },
  },
